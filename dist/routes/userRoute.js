...
router.patch('/users/update/:id', protected_1.default, roleAuth.checkRole(['User']), isBlocked_1.isBlocked, userController.updateProfile);
router.patch('/users/update-password/:id', protected_1.default, roleAuth.checkRole(['User']), isBlocked_1.isBlocked, userController.resetPassword);
