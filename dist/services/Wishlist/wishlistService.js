...
let WishlistService = class WishlistService {
    ...
    addToWishlist(user, packageId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!user || !packageId)
                return false;
            const data = {
                userId: new mongoose_1.default.Types.ObjectId(user),
                packageId: new mongoose_1.default.Types.ObjectId(packageId),
            };
            const response = yield this._wishlistRepository.createNewData(data);
            if (response)
                return true;
            else
                return false;
...
exports.WishlistService = WishlistService = __decorate([
    ...
    __param(0, (0, inversify_1.inject)("IWishlistRepository")),
