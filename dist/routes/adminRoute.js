...
router.get('/users/:user/:perPage/:page', protected_1.default, roleAuth.checkRole(['Admin']), adminController.getAllData);
...
router.get('/categories/', protected_1.default, roleAuth.checkRole(['Admin']), adminController.getCategories);
