...
export class AgentController{
 ...
 getCategories = asyncHandler(async (req: Request, res: Response) =>{
  ...
  getSignedUrls = asyncHandler(async (req: Request, res: Response,next: NextFunction) =>{
  ...
  deleteImages = asyncHandler(async (req:Request,res: Response,next : NextFunction) => {
     try{
  ...
  getDashboardData = asyncHandler(async (req: Request, res: Response,next:NextFunction) => {
     try{
